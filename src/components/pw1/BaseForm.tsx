...
const u=<div className="mt-32 flex h-full [&_input]:ps-2 [&_input]:rounded [&_input]:mb-2 [&_input]:w-full [&_input:invalid]:outline-red-600 [&_label::after]:[content:'*'] [&_label::after]:text-red-600" >
